...
PrimeFaces.widget.Dialog = PrimeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        else if(!(this.cfg.appendToBody == "false")){
        	this.jq.appendTo(PrimeFaces.expressions.SearchExpressionFacade.resolveComponentsAsSelector(this.cfg.appendToBody));
        }
    ...
    refresh: function(cfg) {
        ...
        else if(!(cfg.appendToBody == "false")){
...
PrimeFaces.widget.ConfirmDialog = PrimeFaces.widget.Dialog.extend({
    ...
    init: function(cfg) {
        ...
        if ((!cfg.appendTo && cfg.global) || !(cfg.appendToBody == "false")) {
        	cfg.appendTo = '@(body)';
        }
